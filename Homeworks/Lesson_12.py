...
# import pathlib # узнаем абсолютный путь к открытому файлу 
...
# # read_file('test.txt') # вычитываеи и печатаем все содежимое файла 

# data_from_first_file = read_file('test.txt')
# data_from_first_file2 = read_file('test2.txt')

# print(data_from_first_file2['temp'])
